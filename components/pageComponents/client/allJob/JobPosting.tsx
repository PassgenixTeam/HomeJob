...
import ItemJobDraft from '@/components/pageComponents/client/allJob/components/ItemJobDraft';
import ItemJob from '@/components/pageComponents/client/allJob/components/ItemJob';
...
const JobPosting = () => {
  ...
  const [myJobs, setMyJobs] = React.useState<IJobRespond[]>([]);
      ...
      <div className="flex justify-between items-center px-8 py-3 gap-6">
        ...
        <div className="basis-1/2">
          <Button
            ...
            icon={
              !showFilter ? (
                <svg
                  ...
                  width={24}
                  height={24}
                  className="fill-[color:var(--primary-7)]"
                >
            ...
            className="rounded-full font-bold hover:bg-[color:var(--primary-1)]"
            title="Filters"
