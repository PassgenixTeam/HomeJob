...
export default function AdditionalDetail(props: AdditionalDetailProps) {
  ...
  return (
    <section className="px-8 py-4 border rounded-2xl">
      <h6 className="text-2xl font-medium mb-12"> Mô tả thêm thông tin</h6>
      <div>
        <FastField component={TextareaField} name="coverLetter" rows={8} placeholder="" title="" />
        <span className="text-[color:var(--red-err)] font-medium"></span>
      </div>
      <div className="mt-6">
        <h6 className="font-medium mb-3">Tệp đính kèm</h6>
        <div className="my-6">
