...
export const projectLengthString: Record<PROJECT_LENGTH, string> = {
  [PROJECT_LENGTH.LESS_THAN_ONE_MONTH]: 'Less than 1 month',
  [PROJECT_LENGTH.MORE_THAN_SIX_MONTHS]: 'More than 6 months',
  [PROJECT_LENGTH.ONE_TO_THREE_MONTHS]: '1 to 3 months',
  [PROJECT_LENGTH.THREE_TO_SIX_MONTHS]: '3 to 6 months',
};
